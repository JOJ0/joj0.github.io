...
As mentioned at the very [top](#top) of this post most Arduinos are not capable of showing up as proper MIDI device in your computer's operating system. If you are fine with using a software MIDI bridge like "hairless MIDI bridge", just look at the first picture in this chapter and you are done. If not, one of the cheapest solutions around is to steal the electronics of a USB to MIDI Adapter cable, You can get them in Europe for about 7-10 €. Certainly if you order them in China, a few pieces of them will cost you about almost nothing. And btw: These cheap adapter cables are pretty useless for serious MIDI applications like controlling a synth out of your DAW. They are built so cheap, they loose data or just hang and can't handle too much MIDI data. Believe me, I measured it. Bute they are definitely good enough to be used as sending some knob or button movement. That's only a tiny amount of data and they can handle that.

<div class="pic_row_3">
  <div class="pic_left">
    {% include thumb.html filename='/images/2018-11-17-midictrl1/matrixmidi-30.jpg' caption="I decided to use a fresh Arduino Nano, solder the wires directly to it and keep the pin-headered Nano for breadboarding purposes. 7 keypad wires connected to digital pins. USB port transports power and data. This is the final software simulated MIDI variant." %}
  </div>
  <div class="pic_middle">
    {% include thumb.html filename='/images/2018-11-17-midictrl1/matrixmidi-31.jpg' caption="Only a few Arduino's can make use of their" %}
  </div>
  <div class="pic_right">
